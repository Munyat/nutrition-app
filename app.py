...
def index():
     ...
     if request.method == 'POST':
         ...
         database_time = date_time.strftime('%Y%m%d')
...
def view(date):
    ...
    if request.method == 'POST':
        ...
        # Insert or ignore if the entry already exists
        db.execute('INSERT OR IGNORE INTO food_date (food_id, log_date_id) VALUES (?, ?)', (food_id, log_date_id))
        db.commit()
